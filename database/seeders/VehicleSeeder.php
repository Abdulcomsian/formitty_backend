...
class VehicleSeeder extends Seeder
{
    ...
    public function run()
    {
        $topSection = "<table style='background-color:#7209B7; border:none; width:100%;'>
                        <tr>
                            <td>
                                <p style='font-size:12pt; font-weight:bold; margin-top:5px; margin-bottom:5px; color: white'>  Notes for Assistive Technology (AT) Assessors of General AT Supports</p>
                            </td>
                        </tr>
                    </table>
                    <p style='font-weight: bold'>There are specific templates available for the following types of Assistive Technology (AT):</p>
                    <ul style='margin-bottom: 10px; margin-top: 10px'>
                        ...
                        <li>Dog Guide Assessment</li>
                        <li>Nutrition and Dysphagia Assistive Technology Supports Assessment</li>
                    </ul>
                    ...
                    <table style='background-color:#7209B7; border:none; width:100%;'>
                        <tr>
                            <td>
                                <p style='font-size:12pt; font-weight:bold; margin-top:5px; margin-bottom:5px; color: white'>Notes for navigating and editing this document</p>
                            </td>
                        </tr>
                    </table>
