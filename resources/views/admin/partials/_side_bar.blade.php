               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="{{ route('admin.general.site.identity') }}"
                                  class="nav-link {{ request()->is('admin/general-settings/site-identityss') ? 'active' : '' }}">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>
                                      Basic Setting
                                  </p>
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.general.chatgpt.prompts') }}"
                                class="nav-link {{ request()->is('admin/general-settings/chatgpt-prompts') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    ChatGpt Prompts
                                </p>
