                    ...
                    <div class="card">
                        <div class="card-header">
                           {{-- <div class="form-group float-right">
                                <a href="{{ route('form-builder.create') }}" class="btn btn-primary">
                                    <i class="fa fw fa-plus"></i>
                                    Add Form
                                </a>
                            </div>--}}
                            <h4 class="float-left">Forms List</h4>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        @foreach ($forms as $form)
                                            <tr>
                                                <td>
                                                    <div class="checkbox checkbox-success m-0">
                                                        <input id="checkbox{{ $form->id }}" type="checkbox"
                                                               name="forms[]" value="{{ $form->id }}">
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" href="{{route('admin.formHeading', $form->id)}}"
                                                       title="View Form">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm"
                                                       onclick="event.preventDefault();del({{ $form->id }});"
                                                       title="Delete Form" href="javascript:void(0)">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    <a class="btn btn-primary btn-sm"
                                                       href="{{route('admin.getFormFields',$form->id)}}"
                                                       title="View Form">
