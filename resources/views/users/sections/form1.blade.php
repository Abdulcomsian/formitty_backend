...
@php $section = $phpWord->addSection();
@endphp
@php
...
$image_path = '{{asset("images/logo.jpg")}}';
$headerParagraph->addText('Continence Related Assistive Technology Assessment Template', $fontStyle);

$fontStyleFooter = new \PhpOffice\PhpWord\Style\Font();
$fontStyleFooter->setName('Arial')
          ->setSize(12)
          ->setColor('#000000')
          ->setBold(false);

$footer = $section->addFooter();
$footer->addText('Continence Template', $fontStyleFooter);
$footer->addPreserveText('Page {PAGE} of {NUMPAGES}', $fontStyleFooter, array('align' => 'right'));
@endphp
<?php
$html = <<<'EOT'
...
<table style="background-color:#6a2c75; border:none; width:100%; margin-top:20px">
    <tr>
        <td>
            <p style="font-size:14pt; font-weight:bold; margin-top:8px; margin-bottom:8px; color: white">  Notes for AT Assessors of Continence AT Supports</p>
        </td>
    </tr>
</table>
...
<p style="margin-bottom: 10px; font-size: 11pt">Spelling and grammar can be checked according to the word processor you are using. The document can be navigated with just the Tab key to encompass varying modes of navigation and levels of computer skills</p>
    ...
    >
      <tbody>
        <tr>
          ...
          <td style="border: 1px solid lightslategray; padding: 10px; font-size: 17px">{{$name}}</td>
        </tr>
        <tr>
